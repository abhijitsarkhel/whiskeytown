...
import org.training.constants.TraininginitialdataConstants;



/**
 * This is the extension manager of the Traininginitialdata extension.
 */
public class TraininginitialdataManager extends GeneratedTraininginitialdataManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TraininginitialdataManager.class.getName());
	 ...
	 */
	public static TraininginitialdataManager getInstance()
	{
		return (TraininginitialdataManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TraininginitialdataConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TraininginitialdataManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TraininginitialdataManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TraininginitialdataManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TraininginitialdataManager called, current tenant: " + getTenant().getTenantID());
		}
	}
