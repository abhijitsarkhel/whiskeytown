...
import org.training.constants.TrainingtestConstants;



/**
 * This is the extension manager of the Trainingtest extension.
 */
public class TrainingtestManager extends GeneratedTrainingtestManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TrainingtestManager.class.getName());
	 ...
	 */
	public static TrainingtestManager getInstance()
	{
		return (TrainingtestManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TrainingtestConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TrainingtestManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TrainingtestManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TrainingtestManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TrainingtestManager called, current tenant: " + getTenant().getTenantID());
		}
	}
