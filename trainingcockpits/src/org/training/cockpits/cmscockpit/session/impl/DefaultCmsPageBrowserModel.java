...
import org.training.cockpits.cmscockpit.components.contentbrowser.DefaultCmsPageContentBrowser;
import org.training.cockpits.cmscockpit.components.contentbrowser.DefaultCmsPageMainAreaPreviewComponentFactory;
...
public class DefaultCmsPageBrowserModel extends CmsPageBrowserModel
{
	...
	{
		return new DefaultCmsPageBrowserModel(getCmsAdminSiteService(), getCmsCockpitService(), getModelService(),
				getAdminComponentService(), getCMSAdminContentSlotService());
	}
