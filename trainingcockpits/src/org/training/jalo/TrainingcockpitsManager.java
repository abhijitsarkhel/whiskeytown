...
import org.training.constants.TrainingcockpitsConstants;



/**
 * This is the extension manager of the Trainingcockpits extension.
 */
public class TrainingcockpitsManager extends GeneratedTrainingcockpitsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TrainingcockpitsManager.class.getName());
	 ...
	 */
	public static TrainingcockpitsManager getInstance()
	{
		return (TrainingcockpitsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TrainingcockpitsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TrainingcockpitsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TrainingcockpitsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TrainingcockpitsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TrainingcockpitsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
