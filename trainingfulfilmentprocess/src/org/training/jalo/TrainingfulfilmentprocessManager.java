...
/**
 * This is the extension manager of the Trainingfulfilmentprocess extension.
 */
public class TrainingfulfilmentprocessManager extends GeneratedTrainingfulfilmentprocessManager
{
	...
	{
		return (TrainingfulfilmentprocessManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TrainingfulfilmentprocessConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TrainingfulfilmentprocessManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TrainingfulfilmentprocessManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TrainingfulfilmentprocessManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TrainingfulfilmentprocessManager called, current tenant: " + getTenant().getTenantID());
		}
	}
