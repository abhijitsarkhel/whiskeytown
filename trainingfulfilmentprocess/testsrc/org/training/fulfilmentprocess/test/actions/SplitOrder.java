...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter
				.setName(org.training.fulfilmentprocess.constants.TrainingFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(org.training.fulfilmentprocess.constants.TrainingFulfilmentProcessConstants.PARENT_PROCESS);
