...
/**
 * This is the extension manager of the Trainingcore extension.
 */
public class TrainingcoreManager extends GeneratedTrainingcoreManager
{
	 ...
	 */
	public static TrainingcoreManager getInstance()
	{
		return (TrainingcoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TrainingcoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TrainingcoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TrainingcoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TrainingcoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TrainingcoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
