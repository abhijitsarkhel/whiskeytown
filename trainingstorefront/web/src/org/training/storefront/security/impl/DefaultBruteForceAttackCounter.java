...
import org.training.storefront.security.BruteForceAttackCounter;
...
public class DefaultBruteForceAttackCounter implements BruteForceAttackCounter
{
	...
	{
		bruteForceAttackCache = new ConcurrentHashMap<String, DefaultBruteForceAttackCounter.LoginFailure>((int) 0.5
				* cacheSizeLimit.intValue());
