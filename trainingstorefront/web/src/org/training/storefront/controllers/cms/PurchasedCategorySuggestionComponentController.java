...
/**
 * @author abhijit.s Controller for CMS PurchasedCategorySuggestionComponent
 */
		...
		AbstractCMSComponentController<PurchasedCategorySuggestionComponentModel>
{
	...
	{
		final List<ProductData> productSuggestions = simpleSuggestionFacade.getReferencesForPurchasedInCategory(component
				.getCategory().getCode(), component.getProductReferenceTypes(), component.isFilterPurchased(), component
