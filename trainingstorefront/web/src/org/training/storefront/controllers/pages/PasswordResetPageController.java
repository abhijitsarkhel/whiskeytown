...
/**
 * @author abhijit.s Controller for the forgotten password pages. Supports requesting a password reset email as well as
 *         changing the password once you have got the token that was sent via email.
 */
@Controller
@Scope("tenant")
