...
import org.training.constants.TrainingstorefrontConstants;



/**
 * This is the extension manager of the Trainingstorefront extension.
 */
public class TrainingstorefrontManager extends GeneratedTrainingstorefrontManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TrainingstorefrontManager.class.getName());
	 ...
	 */
	public static TrainingstorefrontManager getInstance()
	{
		return (TrainingstorefrontManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TrainingstorefrontConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TrainingstorefrontManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TrainingstorefrontManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TrainingstorefrontManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TrainingstorefrontManager called, current tenant: " + getTenant().getTenantID());
		}
	}
